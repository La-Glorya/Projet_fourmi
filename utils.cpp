...
void fourmisG(sf::RenderTexture& tex, const int& x, const int& y, const int& color)
{
	static sf::Texture rect;
	static sf::Sprite sprite;
	rect.loadFromFile("guerriere.png");
    sprite.setTexture(rect);
    sprite.setPosition(x * SQUARE_SIZE, y * SQUARE_SIZE);
    sprite.setColor(sf::Color(color));
	tex.draw(sprite);
}

void fourmisReine(sf::RenderTexture& tex, const int& x, const int& y, const int& color)
{
	static sf::Texture rect;
	static sf::Sprite sprite;
	rect.loadFromFile("reine.png");
    sprite.setTexture(rect);
    sprite.setPosition(x * SQUARE_SIZE, y * SQUARE_SIZE);
	tex.draw(sprite);
}

void fourmisO(sf::RenderTexture& tex, const int& x, const int& y, const int& color)
{
	static sf::Texture rect;
	static sf::Sprite sprite;
	rect.loadFromFile("ouvriere.png");
    sprite.setTexture(rect);
    sprite.setPosition(x * SQUARE_SIZE, y * SQUARE_SIZE);
	tex.draw(sprite);
}
